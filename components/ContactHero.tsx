  ...
  return (
    <section ref={targetRef} className="relative w-full h-[60vh] lg:h-[70vh] flex flex-col items-center justify-center overflow-hidden bg-[#fdfaf6] p-6 lg:p-12">
      ...
      <motion.div 
        ...
        style={{ opacity }}
        className="relative z-10 bg-[#f8f3eb]/95 backdrop-blur-xl px-12 py-16 lg:px-24 lg:py-20 rounded-[50px] lg:rounded-[100px] shadow-[0_30px_100px_-20px_rgba(0,0,0,0.15)] flex flex-col items-center text-center max-w-4xl border border-white/40"
      >
        ...
        {/* Breadcrumbs */}
        <div className="flex items-center gap-2 mb-8 text-xs font-bold tracking-widest text-[#b38e5d]/60">
           <Link href="/" className="hover:text-[#b38e5d] transition-colors">HOME</Link>
           <ChevronRight size={12} />
           <span className="text-[#b38e5d]">CONTACT US</span>
        </div>
        ...
        <RevealText 
          text="Contact Us" 
          className="text-[#4d3a2e] text-5xl md:text-7xl lg:text-8xl font-black mb-10 leading-tight"
          delay={0.8}
        />
